...
const MemberManage = () => {
    ...
    <div className="container py-10">
                <h1 className="h4 mt-4 mb-6 d-none d-lg-block">會員管理</h1>
            <table className="table table-hover table-brand-400 table-sm align-middle">
                <thead>
                    <tr>
                        <th className="text-center ">頭像</th>
                        <th className="text-center ">暱稱</th>
                        <th className="text-center  d-lg-table-cell d-none">信箱</th>
                ...
                <tbody>
                    {
                        memberInfo.map(member=>
                            <tr key={member.id}>
                                ...
                                <td className="py-5 w-25 d-lg-table-cell d-none">{member.email}</td>
                                ...
                                <td className="text-center py-5">
                                    ...
                                    {/* 手機版 */}
                                    <button onClick={(e) => editMember(e, member)} name="isPublic" value='false' type="button" className={`btn text-white d-lg-none ${member.isPublic == 0 ? "d-none" : " btn-brand-400"}`}>正常</button>
                                    <button onClick={(e) => editMember(e, member)} name="isPublic" value='true' type="button" className={`btn text-white d-lg-none ${member.isPublic == 1 ? "d-none" : " btn-brand-800"}`}>封鎖</button>
                                </td>
                            </tr>
                        )
                    }
